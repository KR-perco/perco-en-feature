<?
$MESS['SEARCH_ALL']="ЈЁИ«ІїЈ©";
$MESS['SEARCH_GO']="И·¶Ё";
$MESS['SEARCH_ERROR']="Error in search phrase:";
$MESS['SEARCH_CORRECT_AND_CONTINUE']="ЗлХэИ·ЛСЛч¶МУпІўФЩКФТ»ґОЎЈ";
...
$MESS['SEARCH_OPERATOR']="ФЛЛг";
$MESS['SEARCH_SYNONIM']="ЅьТеґК";
$MESS['SEARCH_DESCRIPTION']="ЛµГч";
$MESS['SEARCH_AND']="єН";
...
$MESS['SEARCH_OR']="»т";
$MESS['SEARCH_OR_ALT']="ІЩЧчФ±<I>єПАнµД»т</I> ФКРнС°ХТКµМеЦБЙЩ°ьє¬ЖдЦРµДІЩЧчКэЎЈ";
$MESS['SEARCH_NOT']="Оґ";
$MESS['SEARCH_NOT_ALT']="ІЩЧчФ±<I>ВЯј­Г»УР</I> ПЮЦЖБЛЛСЛчµЅТіГжІ»°ьє¬ІЩЧчКэЎЈ";
$MESS['SEARCH_BRACKETS_ALT']="<I>ROUND BRACKETS</I>¶ЁТеБЛВЯј­ІЩЧч·ыУЕПИґОРтЎЈ";
$MESS['SEARCH_MODIFIED']="Modified:";
$MESS['SEARCH_NOTHING_TO_FOUND']="єЬТЕє¶Ј¬ДъµДЛСЛчІ»Па·ыєПµДИОєООДјюЎЈ";
$MESS['SEARCH_PATH']="Path:";
$MESS['SEARCH_SORT_BY_RANK']="Па№ШРФЕЕРт";
$MESS['SEARCH_SORTED_BY_DATE']="ЕЕРтИХЖЪ";
$MESS['SEARCH_SORTED_BY_RANK']="ТС°ґ№ШБЄ·ЦАа";
$MESS['SEARCH_SORT_BY_DATE']="ЕЕРтИХЖЪ";
?>
