...
mkdir('/upload/export/'.$current_date, 0777, true);

$folder = '/upload/export/'.$current_date;
$arhive = '/upload/export/'.$current_date.'.zip';
...
if (in_array("photo", $_POST["fields"])){
    ...
    mkdir('/upload/export/'.$current_date.'/images', 0777, true);
    $folder_images = '/upload/export/'.$current_date.'/images';
}
...
$json_file = '/upload/export/'.$current_date.'/data.json';
...
function getProp($propId, $date) {
    ...
    while($obProp = $Prop->GetNextElement()){
        ...
        if (in_array("sheme", $_POST["fields"])){
            mkdir('/upload/export/'.$date.'/sheme', 0777, true);
            $folder_sheme = '/upload/export/'.$date.'/sheme';
        ...
        if (in_array("docs", $_POST["fields"])){
            mkdir('/upload/export/'.$date.'/docs', 0777, true);
            $folder_docs = '/upload/export/'.$date.'/docs';
